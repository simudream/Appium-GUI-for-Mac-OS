...
//    BOOL installationRequired = ![NodeInstance instanceExistsAtPath:@"/usr/local/bin"];
//    installationRequired |= ![NodeInstance packageIsInstalledAtPath:@"/usr/local/lib" withName:@"appium"];
//	
...
//    {
	...
	//Fix bug
        [[self mainWindowController] setNode:[[NodeInstance alloc] initWithPath:@""]];
  //  }
